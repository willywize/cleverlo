								...
								<div class="add-listing-headline">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<!-- Type -->
											<div class="col-md-12">
												<h5>Session Name<i class="tip" data-tip-content="Session Name"></i></h5>
												<input type="text" placeholder="">
											</div>

											<div class="col-md-3">
												<h5>Start Date<i class="tip" data-tip-content="Start Date"></i></h5>
												<input type="text" placeholder="DD/MM/YYYY">
											</div>

											<!-- Type -->
											<div class="col-md-3">
												<h5>Start Hour<i class="tip" data-tip-content="Start Hour"></i></h5>
												<input type="text" placeholder="00:00">
											</div>

											<div class="col-md-3">
												<h5>End Date<i class="tip" data-tip-content="End Date"></i></h5>
												<input type="text" placeholder="DD/MM/YYYY">
											</div>

											<!-- Type -->
											<div class="col-md-3">
												<h5>End Hour<i class="tip" data-tip-content="End Hour"></i></h5>
												<input type="text" placeholder="00:00">
											</div>
						...
						<div class="add-listing-headline">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<!-- Type -->
									<div class="col-md-6">
										<h5>Last Registration <i class="tip" data-tip-content="Last registration"></i></h5>
										<input type="text" placeholder="">
									</div>
									...
									<!-- Type -->
									<div class="col-md-4">
										<h5>Coupon Limit (Person)<i class="tip" data-tip-content="Coupon Limit"></i></h5>
										<input type="text" placeholder="">
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-6 margin-bottom-20">
										...
										<select class="chosen-select-no-single" >
											<option label="blank">Select Answer</option>
											<option>Yes</option>
											<option>No</option>
										</select>
									</div>
