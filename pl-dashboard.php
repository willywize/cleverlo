		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6">
				<div class="dashboard-stat color-7">
					<div class="dashboard-stat-content"><h4>2000000</h4> <span>Total Balance (Rp.)</span></div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="dashboard-stat color-2">
					<div class="dashboard-stat-content"><h4>26</h4> <span>Workshop Held</span></div>
					<div class="dashboard-stat-icon"><i class="im im-icon-Board"></i></div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="dashboard-stat color-1">
					<div class="dashboard-stat-content"><h4>60</h4> <span>Participants</span></div>
					<div class="dashboard-stat-icon"><i class="im im-icon-Cinema"></i></div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="dashboard-stat color-1">
					<div class="dashboard-stat-content"><h4>6</h4> <span>Upcoming Workshop</span></div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="dashboard-stat color-3">
					<div class="dashboard-stat-content"><h4>95</h4> <span>Pending Workshop</span></div>
					<div class="dashboard-stat-icon"><i class="im im-icon-File-Loading"></i></div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="dashboard-stat color-4">
					<div class="dashboard-stat-content"><h4>126</h4> <span>Rejected Workshop</span></div>
					<div class="dashboard-stat-icon"><i class="im im-icon-File-Refresh"></i></div>
				</div>
			</div>
		</div>
