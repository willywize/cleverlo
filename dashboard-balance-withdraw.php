				...
				<div class="dashboard-list-box margin-top-0">
					...
					<div id="small-dialog" class="zoom-anim-dialog mfp-hide">
						...
						<div class="message-reply margin-top-0">
							...
							<div class="col-md-12">
								<h5>Total Fee<i class="tip" data-tip-content="Bank"></i></h5>
								<input type="text" placeholder="">
							</div>
							<div class="col-md-12">
					...
					<h4><i class="im im-icon-Bar-Chart pt-blc"></i> Total Points : <span style="color:green">30</span></h4>
					<ul>
						...
						<li class="pending-booking">
							<div class="list-box-listing bookings">
								<div class="list-box-listing-content">
									<div class="inner">
										<h3>Total Withdraw : 150 Points <span class="booking-status">On Process</span></h3>
						...
						<li class="approved-booking">
							<div class="list-box-listing bookings">
								<div class="list-box-listing-content">
									<div class="inner">
										<h3>Total Withdraw : 150 Points <span class="booking-status">Paid on 11 May 2018</span></h3>
